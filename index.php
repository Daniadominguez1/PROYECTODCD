    ...
    <div class="container" style="padding-top:150px">
        <div class="row" style="background-color: rgb(253,219,170); text-align: center;">
            ...
            <div class="col" style="background-color:#000497">
                <h1 style="color: #ecf1ff">Autentificacion</h1>
                ...
                <form style="padding: 25px;" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label" style="color:#ffffff; font-size:20px">Correo electrónico</label>
                        <input type="email" class="form-control" id="correo" aria-describedby="emailHelp" name="correo">
                        <div id="emailHelp" class="form-text"style="color:#ffffff; font-size:20px">No olvides ingresar tus datos!!.
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label"style="color:#ffffff; font-size:20px">Contraseña</label>
                        <input type="password" class="form-control" id="contra" name="contra">
                    </div>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
                        <label class="form-check-label" for="flexSwitchCheckDefault"style="color:#ffffff; font-size:20px">Verifica</label>
