...
} else if (time() - $_SESSION['tiempo'] > 1000000) {
    session_destroy();
    echo "
...
<body>
    <div class="container-fluid" style="text-align: center; padding-top:40px; background-color:#eef6ff">
        <div class="row">
            <div class="col-3">
                <img src="img/ll.png" width="100px" height="100px" style="padding-top: 5px;">
            </div>
            <div class="col">
