...
<td><a href="editar_productos.php?id=<?php echo $datos['idprod']; ?>">
                            <button type="button" class="btn btn-warning"> <img src="img/pencil.png" height="16px"
                                    width="16px">
                            </button>
                        </a>
                    </td>
                    <td><a href="../Servidor/borrar_producto.php?id=<?php echo $datos['idprod']; ?>"><button type="button"
                                class="btn btn-danger"><img src="img/delete.png" height="16px" width="16px">
                            </button>
                        </a>
                    </td>
                </tr>
