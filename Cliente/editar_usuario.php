    ...
    <div class="col-lg-6 m-auto">
      <form action="" method="post">
        ...
        <div class="form-group">
          ...
          <input type="text" placeholder="Ingrese nombre" class="form-control" name="NomUsu" id="nombre" disabled value="<?php echo $nombre; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <input type="text" placeholder="Ingrese apellido paterno" class="form-control" name="ApaUsu" id="ApaUsu" disabled value="<?php echo $ApaUsu; ?>">
        </div>
        <div class="form-group">
          <label for="AmaUsu">Apellido Materno</label>
          <input type="text" placeholder="Ingrese apellido materno" class="form-control" name="AmaUsu" id="AmaUsu" disabled value="<?php echo $AmaUsu; ?>">
        </div>
        <div class="form-group">
